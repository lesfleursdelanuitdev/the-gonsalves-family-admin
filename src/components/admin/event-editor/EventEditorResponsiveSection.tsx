...
import type { EventEditorSectionId } from "@/components/admin/event-editor/event-editor-nav";

export type EventEditorAccordionKey = EventEditorSectionId;

type Props = {
  id: EventEditorSectionId;
  sectionKey: EventEditorAccordionKey;
  title: string;
  description: string;
  icon: LucideIcon;
  summary: string;
  isDesktop: boolean;
  mobileExpanded: EventEditorAccordionKey | null;
  onMobileToggle: (key: EventEditorAccordionKey) => void;
  children: ReactNode;
};

export function EventEditorResponsiveSection({
  id,
  sectionKey,
  title,
  description,
