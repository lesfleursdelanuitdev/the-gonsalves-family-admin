...
export type PersonEditorAccordionKey =
  | "person-basic"
  | "person-names"
  | "person-events"
...
type Props = {
  id: string;
  sectionKey: PersonEditorAccordionKey;
  title: string;
  description: string;
  icon: LucideIcon;
  summary: string;
  isDesktop: boolean;
  mobileExpanded: PersonEditorAccordionKey | null;
  onMobileToggle: (key: PersonEditorAccordionKey) => void;
  children: ReactNode;
};

/**
 * Desktop: always-open section card. Mobile: collapsible summary row + body (accordion).
 */
export function PersonEditorResponsiveSection({
  id,
  sectionKey,
  title,
  description,
