  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        "border-[color-mix(in_oklch,var(--color-base-content)_42%,var(--color-base-300))] app-light:border-[color-mix(in_oklch,var(--color-base-content)_30%,var(--color-base-300))]",
