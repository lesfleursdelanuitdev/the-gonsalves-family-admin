...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Backdrop
    ref={ref}
    className={cn(
      "fixed inset-0 z-[200] bg-black/50 backdrop-blur-sm pointer-events-none data-[closed]:animate-out data-[closed]:fade-out-0 data-[open]:animate-in data-[open]:fade-in-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Viewport
    ref={ref}
    className={cn(
      "fixed inset-0 z-[201] flex min-h-full w-full items-center justify-center p-4",
      className
    )}
    {...props}
  />
